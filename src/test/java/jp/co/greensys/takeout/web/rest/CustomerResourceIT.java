...
public class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().userId(DEFAULT_USER_ID).nickname(DEFAULT_NICKNAME).language(DEFAULT_LANGUAGE);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().userId(UPDATED_USER_ID).nickname(UPDATED_NICKNAME).language(UPDATED_LANGUAGE);
        return customer;
    }
    ...
    public void updateCustomer() throws Exception {
        ...
        updatedCustomer.userId(UPDATED_USER_ID).nickname(UPDATED_NICKNAME).language(UPDATED_LANGUAGE);
