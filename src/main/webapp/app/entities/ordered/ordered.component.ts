...
export class OrderedComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.orderedService
      ...
      .subscribe(
        (res: HttpResponse<IOrdered[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInOrdereds(): void {
    this.eventSubscriber = this.eventManager.subscribe('orderedListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IOrdered[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
