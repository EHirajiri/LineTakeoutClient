...
export class PayComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.payService
      ...
      .subscribe(
        (res: HttpResponse<IPay[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPays(): void {
    this.eventSubscriber = this.eventManager.subscribe('payListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPay[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
